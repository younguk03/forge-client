...
document.write('<br>송신자 메시지:', message1);
document.write('<br>송신자키: ', key);
document.write('<br>송신자 HMAC-SHA1: ', result1);
...
document.write('<br>수신자 메시지:', message2);
document.write('<br>수신자키: ', key1);
document.write('<br>수신자 HMAC-SHA1: ', result2);
document.write('<br>')

if (result1 === result2) {
   console.log('메시지 검증 성공');
   document.write('<br>메시지 검증 성공');
} else {
   console.log('메시지 에러');
   document.write('<br>메시지 에러');
}