...
forge.pkcs5.pbkdf2(
   ...
   function (err, derivedKey) {
      if (err) {
         ...
         document.write('<br>Derived key1(async): ', forge.util.bytesToHex(derivedKey));
      }
...
forge.pkcs5.pbkdf2(
   ...
   function (err, derivedKey) {
      if (err) {
         ...
         document.write('<br>Derived key2(async): ', forge.util.bytesToHex(derivedKey));
      }
...
forge.pkcs5.pbkdf2(
   ...
   function (err, derivedKey) {
      if (err) {
         ...
         document.write('<br>Derived key3(async): ', forge.util.bytesToHex(derivedKey));
      }
...
forge.pkcs5.pbkdf2(
   ...
   function (err, derivedKey) {
      if (err) {
         ...
         document.write('<br>Derived key4(async): ', forge.util.bytesToHex(derivedKey));
      }
...
forge.pkcs5.pbkdf2(
   ...
   function (err, derivedKey) {
      if (err) {
         ...
         document.write('<br>Derived key5(async): ', forge.util.bytesToHex(derivedKey));
      }
